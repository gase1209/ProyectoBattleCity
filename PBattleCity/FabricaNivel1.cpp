...
Actor* FabricaNivel1::crearInstanciaFuego(float _x, float _y) {
...
Actor* FabricaNivel1::crearInstanciaPuaz(float _x, float _y) {
...
Actor* FabricaNivel1::crearInstanciaMina(float _x, float _y) {
...
Actor* FabricaNivel1::crearInstanciaGlobo(float _x, float _y)
{
	Actor* actor = new GloboAdapter();
	actor->setAvatar(avatarGlobo);
	actor->setX(_x);
	actor->setY(_y);
	actor->setGameManager(getGameManager());
	if (getGameManager()->moverActorA(actor, _x, _y) == false)
...
Actor* FabricaNivel1::crearInstanciaTrampa(float _x, float _y) {

	return nullptr;
}


void FabricaNivel1::crearInstanciasMapaNivel1()
{
